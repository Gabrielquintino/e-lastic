    ...
    <section>
        <div class="container">
            <div class="d-flex justify-content-center">
                <div class="card mt-5">
                    <h4 class="text-center mt-5">Faça o Login com Sua Conta</h4>
                    <form class="login-signup-form" method="POST" action="valida.php">
                        <div class="form-group mt-3">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="email" class="form-control" placeholder="nome@endereco.com" name="email" />
                            </div>
                        </div>
                        ...
                        <a class="mt-3" href="cadastro.php" style="float:right;">Cadastrar</a>
                    </form>
